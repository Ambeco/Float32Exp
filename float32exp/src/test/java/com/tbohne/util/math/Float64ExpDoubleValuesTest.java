...
public class Float64ExpDoubleValuesTest {
    ...
    public void whenConstructedFromPositiveRealDoubleThenInternalsAreCorrect() {
        Float64ExpTestUtils.setAndAssertBits(3.141592653589793238462643383279, 0x6487ED51, -29, mDecimal);
    }
    ...
    public void whenConstructedFromNegativeRealDoubleThenInternalsAreCorrect() {
        Float64ExpTestUtils.setAndAssertBits(-3.141592653589793238462643383279, 0x9B7812AF, -29, mDecimal);
    }
