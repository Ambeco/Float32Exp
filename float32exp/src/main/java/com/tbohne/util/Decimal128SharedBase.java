 ...
 */
/*package*/ class Decimal128SharedBase extends Number implements IDecimal128 {
    ...
    /*package*/ static final double LOG_10_2_RATIO = 3.32192809489;
    /*package*/ static final double INV_LOG10 = 0.30102999566398114; // 1/lg(10)
    ...
    /*package*/ Decimal128SharedBase() {significand = 0; exponent = ZERO_EXPONENT;}

    /*package*/ IDecimal128 set(char[] in, int offset, int len) {
        int end = offset + len;
    ...
    /*package*/ IDecimal128 set(BigDecimal val) {
    ...
    /*package*/ IDecimal128 set(BigInteger val) {
    ...
    /*package*/ IDecimal128 set(int significand, int exponent) {
        if (INTERNAL_ASSERTS) {
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof IDecimal128) {
            IDecimal128 other = (IDecimal128) object;
    ...
    public boolean equals(IDecimal128 val) {
     ...
     */
    public boolean approximately(IDecimal128 val, int bitsSimilarCount)
    ...
    @Override
    public int compareTo(IDecimal128 val) {return compareTo(val.significand(), val.exponent());}
    ...
    public boolean lessThan(IDecimal128 val)
    ...
    public boolean lessOrEquals(IDecimal128 val)
    ...
    public boolean greaterOrEquals(IDecimal128 val)
    ...
    public boolean greaterThan(IDecimal128 val)
    ...
    @Override
    public int hashCode() {
        int hash = significand + 0x9e3779b9 + (exponent<<6) + (exponent>>2);
        return hash;
    }
    ...
    public String toString() {
        ...
        toString(sb, DEFAULT_STRING_BASE, DEFAULT_MAX_PRECISION,
    ...
    public StringBuilder toString(StringBuilder sb, int min_digits, int max_digits, int exponentMultiple,
        ...
        if (workingSig != 0) {
            ...
            if (INTERNAL_ASSERTS && !lessOrEquals(workingSig, workingExp)) {
                Assert.fail("{}<={}", this, new Decimal128SharedBase().set(significand, exponent));
            }
    ...
    /**
     * Returns this {@code Decimal128} as a big integer instance. A fractional
     * part is discarded.
     */
    ...
    /**
     * Returns this {@code Decimal128} as a big decimal instance.
     */
    ...
    @Override
    public ImmutableDecimal128 toImmutable() {
        return new ImmutableDecimal128(significand, exponent);
    }
    ...
    /*package*/ static int doubleToSignificand(double val) {
        if (Double.isInfinite(val) || Double.isNaN(val)) {
            throw new UnsupportedOperationException("Decimal128 doesn't support INF or NAN");
        }
        if (val == 0.0) {
            return 0;
        }
    ...
    /*package*/ static void assertNormalized(int significand, long exponent) {
        if (significand > 0) {
    ...
    public static void assertApproximately(IDecimal128 expected, IDecimal128 actual, int bitsSimilarCount) {
        assertApproximately(null, expected, actual, bitsSimilarCount);
    }


    public static void assertApproximately(String message, IDecimal128 expected, IDecimal128 actual, int bitsSimilarCount) {
    ...
    public static void assertApproximately(double expected, IDecimal128 actual, int bitsSimilarCount) {
        assertApproximately(null, expected, actual, bitsSimilarCount);
    }

    public static void assertApproximately(String message, double expected, IDecimal128 actual, int bitsSimilarCount) {
        if(!actual.approximately(expected, bitsSimilarCount)) {
            Assert.fail(Assert.formatCustomized("expected approximately: ", message, expected, actual));
        }
    }
